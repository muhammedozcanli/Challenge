...
{
    public class OrderCompletionResponseExample : IExamplesProvider<SuccessDataResult<object>>
    {
        public SuccessDataResult<object> GetExamples()
        {
            ...
            return new SuccessDataResult<object>(data, "Order completed successfully.");
        }
    }
} 